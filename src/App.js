        ...
        <div className="shadow">
          <main className="main">
            <div className="myflexInput">
              <div className={completedCount === allCount && allCount !== 0 ? 'arrow_active' : 'arrow' } onClick={() => selectAll(state, activeButton)} />
          ...
          {ItemsLeftPure(state) ? 
            ...
            <footer className="myFooter">              
              <div className="Row">
                <button className={activeButton.All} onClick={() => click(state,'All', activeButton)}>All</button>
                <button className={activeButton.Active} onClick={() => click(state, 'Active', activeButton)}>Active</button>
                <button className={activeButton.Completed} onClick={() => click(state, 'Completed', activeButton)}>Completed</button>
